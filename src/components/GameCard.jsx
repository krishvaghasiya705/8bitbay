  ...
  return (
    <Link to={`/gamedetails/${game.id}/`}>
      <div className="h-full bg-cardGrey hover:border-pixelYellow border-2 border-transparent transition-all duration-300 rounded-xl overflow-hidden shadow-lg hover:shadow-pixel">
        <div className="h-[200px] sm:h-[300px] md:h-[400px] overflow-hidden bg-black rounded-t-xl p-2">
          <img
        ...
        <div className="p-4">
          <h2 className="text-pixelRed font-pixel text-base sm:text-lg line-clamp-1">
            {game.name}
          </h2>
